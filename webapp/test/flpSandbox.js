		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#detailmasterv2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"detailmasterv2-display": {
								"semanticObject": "detailmasterv2",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=detailmasterv2",
									"url": sap.ui.require.toUrl("detailmasterv2")
								}
							}
						}
					}
